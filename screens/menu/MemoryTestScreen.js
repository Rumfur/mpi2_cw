...
class MemoryTestScreen extends Component {
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.layout}>
          <View>
            <Image source={require('../../assets/imgMemory.png')} style={styles.logo} /> 
          </View>
        
          <View style={styles.row}>
            <TouchableOpacity
            style={styles.imageColumn}
            onPress={() => navigation.navigate("MemoryT1Screen")}>
              <Image source={require('../../assets/buttonMemoryT1.png')} style={styles.image} /> 
            </TouchableOpacity>
            <TouchableOpacity
            style={styles.imageColumn}
            onPress={() => alert('COMING SOON!')}>
              <Image source={require('../../assets/buttonMemoryT2.png')} style={styles.image} />
            </TouchableOpacity>
          </View>
          <View style={styles.row}>
            <TouchableOpacity
